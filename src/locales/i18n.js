...
const messages = {
	...
	ka: {
		...
		homepage: {
			title: "Pine House Surami &\n Terrace Resort",
			intro: "გთავაზობთ დასვენებას სურამში, ორ ულამაზეს თანამედროვე კოტეჯში.\n სურამი მსოფლიოში ერთ-ერთი საუკეთესო კურორტია,\n გამორჩეულია ჯანმრთელობისთვის სასარგებლო და სამკურნალო თვისებებით, უძველესი ისტორიით, ულამაზესი ბუნებითა და ხედებით.",
